...
\begin{figure}[h!]
    ...
    \begin{subfigure}[b]{0.9\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Gemmini_Internal_SRAM_ExecuteController.pdf}
        \caption{SRAM controllers: ExecuteController module}
        \label{fig:loop_matmul}
    \end{subfigure}
...
\begin{figure}[h!]
    ...
    \caption{The internal structure of the Scratchpad module, showing the various interfaces to the TLB, DMA, and internal memory banks. \cite{gookyi2023gemmini_case_study}.}
