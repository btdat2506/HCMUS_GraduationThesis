...
\begin{itemize}
    ...
    \item \textbf{Virtual Memory Interaction:} The latency and performance implications of the accelerator's DMA engine interacting with the system's TLBs and Page Table Walker.
\end{itemize}
