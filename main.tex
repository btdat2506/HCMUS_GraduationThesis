...
% In 1 mặt
\documentclass[oneside,a4paper,14pt,openright]{extreport}
% In 2 mặt thì tắt comment này
...
% Canh lề
% In 2 mặt thì chuyển từ oneside sang twoside
\usepackage[
  oneside,
  top=20mm,
  bottom=20mm,
...
\newcommand{\tenGVHD}{Huynh~Huu~Thuan,~Dr.}
\newcommand{\tenBM}{}
...
\newcommand{\myname}[1]{\underline{Thanh-Dat Bui}}
